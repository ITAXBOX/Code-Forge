...
public class AttributeWorkflowController {
    ...
    public String saveAttributes(
        ...
        try {
            ...
            String frontend = (String) model.getAttribute("frontendType");
            String backend = (String) model.getAttribute("backendType");
            String database = (String) model.getAttribute("databaseType");

            return attributeService.saveAttributes(projectName, entityName, action, attribute, model, frontend, backend, database);
        } catch (IOException e) {
